...
function HomePage() {
  return (
    <div className="relative mx-auto flex justify-center items-start pb-32">
        <div className="callToAction flex justify-start gap-12  mt-24 items-center flex-col relative px-8 lg:px-0 lg:pl-32 w-full lg:w-[40%]">
          <div className=" relative text-center text-black font-semibold text-[2.5em] leading-[1.5em]">
            ...
            <span className="text-accent-gren">only</span>{" "}
      ...
      transition-transform transform hover:scale-105 hover:bg-[#d85768] focus:outline-none"
        ...
        <div className="Boxes w-[60%] h-[80vh] mt-10 relative hidden lg:block">
          <div className="w-[165px] h-[22px] left-[271px] top-[77px] absolute text-center text-[#fdfdf7] text-[32px] font-normal z-10">
            Feel Free
          </div>
          <div className="w-60 h-[58px] left-[243px] top-[119px] absolute text-center text-white text-4xl font-normal z-10">
            Contact Us{" "}
          </div>
          <HoverEffect />
